...
3. ✅ 无障碍合规 (WCAG 2.1 AA)
4. ⭐ **状态矩阵** - 12 种状态完整定义 (2026-04-01 新增)
5. ⭐ **交互矩阵** - 所有操作 + 反馈定义 (2026-04-01 新增)
6. ⭐ **用户旅程评审** - 参与 Gate 0 评审 (2026-04-01 新增)
7. ⭐ **设计评审** - 主导 Gate 2 设计评审 (2026-04-01 新增)

**设计流程**: `@workspace/DEVELOPMENT_PROCESS_CHECKLIST.md`  
**防逻辑混乱机制**: `@workspace/PRODUCT_UI_DESIGN_OPTIMIZATION.md`
...
- ✅ **基于 FSD 输出设计文档** (无 FSD 不设计)
- ❌ Write frontend code

**方法**: PRD/AC first; tokens mappable to CSS/Tailwind; all states bound to AC

**⭐ 文档先行原则**: 
- ⛔ **无 FSD 不设计** - 必须等 FSD 评审通过后才能开始设计
- ⛔ **无签字不交付** - 设计文档必须经 product-manager 签字后才能交给 dev-engineer
