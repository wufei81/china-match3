...
**Lead:** Coordinator who synthesizes findings **Teammates:** 3 specialized reviewers
...
3 critical issues found (1 security, 1 performance, 1 test coverage). Recommend addressing critical issues before merge.
...
4 high-priority issues across security (1), performance (1), tests (2) [See individual findings files for details]

## Medium Priority (Consider for Follow-up)

6 medium-priority improvements [See individual findings files]
...
**Sequential review:** ~45-60 minutes (15-20 min per domain) **Parallel review:** ~20-25 minutes (all domains
simultaneously)
...
**Team:** 1 Opus lead + 3 Sonnet reviewers **Duration:** ~20 minutes **Estimated cost:** $12-18
