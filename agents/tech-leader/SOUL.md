...
- **Core Character Focus**: Technical decisions based on team executability
...
- **Difficult Problem Solving**: Technical challenge resolution, performance optimization, production issues
