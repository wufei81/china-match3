...
**Lead:** Coordinator who divides work and aggregates results **Teammates:** N workers (typically 3-6), each processing
a subset of items
...
**Items to process:** [PROVIDE LIST OR DIRECTORY - e.g., "All .tsx files in src/components/"]
...
**Total items:** 300 components **Location:** src/components/ **Generated:** 2026-02-16
...
**Items 101-200:** 101. src/components/Modal.tsx 102. src/components/Dropdown.tsx ... 200. src/components/Sidebar.tsx

## Worker 3 (classifier-3)

**Items 201-300:** 201. src/components/Header.tsx 202. src/components/Footer.tsx ... 300. src/components/Dashboard.tsx
```
...
**Total components:** 300 **Processed by:** 3 workers (classifier-1, classifier-2, classifier-3) **Date:** 2026-02-16
...
✅ Total items processed: 300 (matches manifest) ✅ No duplicates detected ✅ No items missed
```
...
**Sequential processing:** ~120 minutes (300 items × 24s avg) **Parallel processing (3 workers):** ~35 minutes (100
items × 24s avg per worker)

**Speedup:** 3-3.5x faster (near-linear scaling)

## Cost Estimate

**Team:** 1 Opus lead + 3 Sonnet workers **Duration:** ~35 minutes **Estimated cost:** $20-28
