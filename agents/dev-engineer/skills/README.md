...
| 技能 | 路径 | 触发词 | 核心功能 |
|------|------|--------|---------|
| **系统设计** | `system-design/` | "设计模式", "DDD", "架构模式" | 设计模式、DDD、架构模式、SOLID 原则 |
| **技术文档** | `technical-writing/` | "RFC", "设计文档", "API 文档" | RFC 撰写、设计文档、API 文档、技术博客 |
| **API 治理** | `api-governance/` | "API 设计", "版本管理", "API 评审" | API 设计规范、版本管理、评审流程、治理框架 |
